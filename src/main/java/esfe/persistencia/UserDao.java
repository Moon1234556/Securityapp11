...
public class UserDao {
     ...
     * o null si ocurre algún error durante la creacion
     ...
     * false en caso contrario.
     * @throws SQLException Sí ocurre un error al interactuar con la base de datos
    ...
    public User authenticate(User user) throws SQLException {
        ...
        try {
            ...
            ps.setString(2, PasswordHasher.hashPassword(user.getPasswordHash())); // Hashear la contraseña proporcionada para
            rs = ps.executeQuery(); // Ejecutar la consulta SQL y obtener el resultado.

            // Verificar si se encontró un registro que coincidió con las credenciales y el estado.
            if (rs.next()) {
        ...
        return userAutenticate; //Retornar el objeto User Autenticado o null si la autenticacion fallo.
    }
