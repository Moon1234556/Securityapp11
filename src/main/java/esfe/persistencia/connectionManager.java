...
public class connectionManager {
     ...
     * ~ DESKTOP-4TMNANE\\SQLEXPRESS:1433 = Dirección del servidor y puerto.
     * - encrypt=true: Indica si la conexión debe ser encriptada.
     * - database=SecurityDB2025: Especifica la base de datos a la que se quiere conectar.
     ...
     */
    private static final String STR_CONNECTION = "jdbc:sqlserver://localhost\\SQLEXPRESS:1433; " +
            "encrypt=true; " +
    ...
    /**
     * Unica instancia de la clase JDBCConnectionManager (para el patrón Singleton).
     ...
     * intentar establecer la conexión, lo cual es importante en entornos multihull.
     *
     ...
     *sea segura en entornos multihull (que varios hilos no intenten crear la instancia al mismo tiempo).
     *
