...
import java.sql.SQLException; // Clase para manejar excepciones relacionadas con la base de datos, aunque no se espera que las pruebas las generen directamente.

import static org.junit.jupiter.api.Assertions.*; // Importación estática de métodos de aserción de JUnit 5 para verificar el comportamiento esperado.
...
class UserDaoTest {
    ...
    private void updatePassword(User user) throws SQLException {
        ...
        // Llama al método 'authenticate' para verificar que la nueva contraseña es válida
    ...
    void testUserDAO() throws SQLException {
        ...
        User user = new User(0, "Test User", "passwordHash", strEmail, (byte) 2);
        ...
        // Llama al método 'authenticate' para verificar que el usuario puede autenticarse con sus credenciales correctas.
        ...
        testUser.setPasswordHash("new_password"); // **Importante:** Actualiza el objeto 'testUser' con la nueva contraseña para la siguiente aserción/prueba.
